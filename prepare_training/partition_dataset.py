...
Partition datasets of images into training and testing sets

optional arguments:
  -h, --help            show this help message and exit
  -i IMAGEDIR, --imageDir IMAGEDIR
                        Path to the folder where the image datasets is stored. If not specified, the CWD will be used.
